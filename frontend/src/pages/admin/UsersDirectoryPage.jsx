      ...
      <div className="relative z-[1] flex-1 px-4 pb-8 pt-5 sm:px-8">
        <section className="min-h-[calc(100vh-6rem)] rounded-md border border-white/[0.08] bg-bg-secondary p-7 shadow-panel">
          <header className="mb-7 flex flex-wrap items-center justify-between gap-4">
            ...
            <button
              type="button"
              className="cursor-pointer rounded-full border-[1.5px] border-primary bg-transparent px-5 py-2 font-sans text-xs font-bold tracking-wider text-primary transition-[background,color] hover:bg-primary/15"
            >
              ADD USER +
            </button>
          </header>
          ...
          <div className="mb-6">
            <input
              ...
              className="w-full rounded-lg bg-white/5 px-4 py-2 text-text-primary outline-none focus:ring-2 focus:ring-primary"
            />
          </div>
